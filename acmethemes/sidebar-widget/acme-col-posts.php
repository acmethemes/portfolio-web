...
if ( ! class_exists( 'Portfolio_Web_Posts_Col' ) ) {
    ...
    class Portfolio_Web_Posts_Col extends WP_Widget {
        ...
        public function form( $instance ) {
	        ...
	        ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'unique_id' ) ); ?>"><?php _e( 'Section ID', 'portfolio-web' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'content_from' ) ); ?>"><?php _e( 'Content From', 'portfolio-web' ); ?>:</label>
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'portfolio_web_img_size' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'portfolio_web_img_size' ) ); ?>">
			        ...
			        foreach( $portfolio_web_image_sizes as $key => $portfolio_web_column_array ){
				        echo ' <option value="'.esc_attr( $key ).'" '.selected( esc_attr( $portfolio_web_img_size ), $key, 0). '>'.esc_html( $portfolio_web_column_array ).'</option>';
			        }
			        ?>
                </select>
            </p>

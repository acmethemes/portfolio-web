...
if ( ! class_exists( 'Portfolio_Web_Contact' ) ) {
    ...
    class Portfolio_Web_Contact extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'shortcode' ) ); ?>"><?php esc_html_e( 'Enter Shortcode', 'portfolio-web' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Select Page For Contact', 'portfolio-web' ); ?>:</label>
                <br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_from' ) ); ?>"><?php _e( 'Page Content From', 'portfolio-web' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_number' ) ); ?>"><?php _e( 'Number of page words in content', 'portfolio-web' ); ?>:</label>
                <br/>
                <small>
                            ...
                            if( !empty ( $page_id ) ) :
                                ...
                                if ( $contact_page_query->have_posts() ):
                                    while( $contact_page_query->have_posts() ):$contact_page_query->the_post();
                                        ?>
                                        <div class="col-md-5  <?php echo esc_attr( $animation ); ?>">
